          ...
          >
            ...
            >
              <v-card
                ...
                class="my-1"
                outlined
                :color="!LBFPcatGroup.visible ? 'grey lighten-4' : ''"
              >
                <v-card-actions class="ma-0 pa-1" >
                  ...
                  >
                  {{LBFPcatGroup.title | toUpperCase}}
                  </span>
                  <v-spacer />
                    <v-icon v-if="LBFPcatGroup.visible">mdi-eye-outline</v-icon>
...
export default {
  ...
  methods: {
    ...
    chgStdFPCatGroup (item) {
      this.$store.dispatch('chgStdFPCatGroup', item)
      eventEmitter.$emit('changedStdFPCatGroup')
    }
  }
}
</script>
