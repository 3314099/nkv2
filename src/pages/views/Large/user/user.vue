          ...
          <v-container grid-list-xl>
            <v-layout row wrap align-center>
              <v-flex xs12 md4>
                ...
                >
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">CRM</v-icon>
                  </v-card-text>
              ...
              <v-flex xs12 md4>
                ...
                >
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">FinPlan</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
              ...
              <v-flex xs12 md4>
                ...
                >
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">ToDos</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
